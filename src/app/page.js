            ...
            {services.map((service, idx) => (
              <div key={idx} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition border border-gray-100">
                ...
                <div className="p-6">
                  ...
                  <button className="mt-6 text-amber-600 font-semibold flex items-center group-hover:gap-2 transition-all">
                    Learn More 
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-lg">+44 123 456 7890</p>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700">info@hashmaintenance.co.uk</p>
